...
# the method should rcdeturn true
# when the string is Apple
...
def remove_all_consonants(string)
  # your code goes here
  string.delete('bcdfghjklmnpqrstvwyz')
end
...
def first_half(string)
  ...
  #find the length of the entire string .length and  then divide it by 2. You can also use splice. Start at index 0.
end
